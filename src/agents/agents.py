...
from lineguard.workflow import lineguard_agent
...
agents: dict[str, Agent] = {
    ...
    "lineguard-agent": Agent(
        description="A controlled transmission-line inspection workflow with human approvals.",
        graph_like=lineguard_agent,
    ),
}
