...
from lineguard.api import router as lineguard_router
...
app.include_router(lineguard_router, dependencies=[Depends(verify_bearer)])
lineguard_paths = ensure_runtime_directories()
app.mount(
    "/lineguard-artifacts",
    StaticFiles(directory=str(lineguard_paths.artifacts_dir)),
    name="lineguard-artifacts",
)
